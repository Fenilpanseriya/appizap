...
export const Loading = (props: LoadingProps) => {
  const loadingProps = {
    $backgroundColor: props.backgroundColor ?? "#007F73",
...
export const LightLoading = (props: LoadingProps) => {
  return <Loading backgroundColor="#fafbff" color="#00aa92" size={props.size} {...props} />;
};

// loading when bg-color is white
export const WhiteLoading = (props: LoadingProps) => {
  return <Loading backgroundColor="#ffffff" color="#00aa92" size={props.size} {...props} />;
};
