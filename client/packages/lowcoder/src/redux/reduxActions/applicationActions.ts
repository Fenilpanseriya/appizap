...
export const createApplication = (payload: CreateApplicationPayload & { containingFolderId?: string }) => ({
...
export const updateAppMetaAction = (payload: UpdateAppMetaPayload & {parentFolderId?: string}) => ({
