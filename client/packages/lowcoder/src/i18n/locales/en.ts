...
export const en = {
  ...
  prop: {
    ...
    disabledPastDates: "Disable Past Dates",
    disabledFutureDates: "Disable Future Dates",
  },
  autoHeightProp: {
    auto: "Auto",
    fixed: "Fixed",
  ...
  uiComp: {
    ...
    stepsCompName: "Steps",
    stepsCompDesc:
      "A Component to make Widgets appear in Stremlined way with Progress Tracker.",
    stepsCompKeywords: "progress, steps",
  ...
  date: {
    ...
    disableDatesTooltip:
      "Please add dates in the array as strings with the same date format, for example: ['2024-04-15', '2024-04-20'].",
  },
  time: {
    start: "Start Time",
    end: "End Time",
  ...
  link: {
    ...
    linkTarget: "Target",
    defaultLink: "https://dev.appizap.ae/",
    linkTooltip: "Tooltip",
  ...
  dropdown: {
    ...
    textDesc: "Text Currently Displayed on Button",
    loadingDesc:
      "Is the Dropdown in Loading State? If True the Current Dropdown Is Loading",
    alignment: "Alignment",
  },
  textShow: {
    text: "### 👋 Hello, {name}",
  ...
  memberSettings: {
    ...
    inviteUserHelp:
      "You Can Copy the Invitation Link to Send to the User to join ",
  ...
  steps: {
    ...
    tooltip: "Tooltip to show on the Step",
    id: "Unique ID of the step",
    widgets: "Widgets to Show on the Step",
    value: "Steps",
    left: "Content Right",
    right: "Content Left",
    alternate: "Alternate Content Order",
    modeTooltip: "Set the Steps to come in Vertical or Horizontal Direction",
    reverse: "Newest Events First",
    pending: "Pending Node Text",
    pendingDescription:
      "When Set, Then a Last Node With the Text and a Waiting Indicator Will Be Displayed.",
    ...
    valueDesc: "Data of Timeline",
    clickedObjectDesc: "Clicked Item Data",
    selectedStepsKey: "Current Step",
    completedBorderColor: "Border Color for Completed Steps",
    initialStep: "Initial Step for Stepper",
    initialStepTooltip:
      "Specify the step from where stepper will start initially",
  },
