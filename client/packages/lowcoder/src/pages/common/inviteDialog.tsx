...
function InviteContent(props: { inviteInfo: InviteInfo }) {
  ...
  return (
    <>
      <HelpText style={{ marginBottom: 16 }}>{trans("memberSettings.inviteUserHelp")} { inviteInfo.invitedOrganizationName} </HelpText>
      <div>
...
function InviteDialog(props: {
  ...
  const orgId = props.orgId ?? user.currentOrgId;
  // const { orgId } = props;
