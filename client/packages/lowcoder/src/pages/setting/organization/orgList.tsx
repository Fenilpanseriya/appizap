...
import { AddIcon, CustomModal, DangerIcon, EditPopover, InviteUserIcon } from "lowcoder-design";
...
import InviteDialog from "@lowcoder-ee/pages/common/inviteDialog";
                            ...
                            <Form layout="vertical" form={form}>
                              <Form.Item
                                ...
                                label={transToNode("orgSettings.deleteModalLabel", {
                                  name: (
                                    <span style={{ color: "#00aa92", margin: "0 5px" }}>
                                      {item.orgName}
                                    </span>
                                  ),
                                })}
