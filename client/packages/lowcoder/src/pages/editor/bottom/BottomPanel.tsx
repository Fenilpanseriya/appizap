...
const Bottom: React.FC<BottomProps> = ({ togglePanel, panelStatus }) =>{
  ...
  const [bottomHeight, setBottomHeight] = useState(panelStatus?.bottom ? panelStyle.bottom.h : 40);
  ...
  return (
    <>
      ...
      <StyledResizableBox
        width={Infinity}
        height={panelStatus?.bottom ? panelStyle.bottom.h : 40}
        resizeHandles={["n"]}
      ...
      >
       <BottomContent togglePanel={togglePanel} panelStatus={panelStatus}/>    
      </StyledResizableBox>
    </>
  );
}
