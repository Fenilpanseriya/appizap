...
export const BottomContent:React.FC<BottomContentProps> = ({ togglePanel, panelStatus }) => {
...
function BottomLeft(props: BottomLeftProps) {
  const { items, onOpenCreatePanel, onCopy, onSelect, onDelete, togglePanel, panelStatus } = props;
  const editorState = useContext(EditorContext);
