...
export type StrokeWidthConfig = CommonColorConfig & {
  readonly strokeWidth: string;
};

export type CounterClockwiseConfig = CommonColorConfig & {
  readonly counterClockwise: string;
};

export type SizeConfig = CommonColorConfig & {
...
export type TextIndentConfig = CommonColorConfig & {
  readonly textIndent: string;
};

export type LetterSpacingConfig = CommonColorConfig & {
  readonly letterSpacing: string;
};

export type WordSpacingConfig = CommonColorConfig & {
  readonly wordSpacing: string;
};

export type FontVariantConfig = CommonColorConfig & {
...
const STROKE_WIDTH = {
  name: "strokeWidth",
  label: trans("style.strokeWidth"),
  strokeWidth: "strokeWidth",
} as const;

const COUNTER_CLOCKWISE = {
  name: "counterClockwise",
  label: trans("style.counterClockwise"),
...
const TEXT_INDENT = {
  name: "textIndent",
  label: trans("style.textIndent"),
  textIndent: "textIndent",
} as const;

const LETTER_SPACING = {
  name: "letterSpacing",
  label: trans("style.letterSpacing"),
  letterSpacing: "letterSpacing",
} as const;

const WORD_SPACING = {
  name: "wordSpacing",
  label: trans("style.wordSpacing"),
  wordSpacing: "wordSpacing",
} as const;

const FONT_VARIANT = {
  name: "fontVariant",
  label: trans("style.fontVariant"),
...
function getLoaderColor(depTheme: keyof ThemeDetail = "primarySurface") {
  return {
    name: "LoaderColor",
    label: "Loader Color",
    depTheme: depTheme,
...
export const StepsStyle = [
  getBackground(),
  {
    name: "completedBorderColor",
    label: trans("steps.completedBorderColor"),
    color: "#E71616",
