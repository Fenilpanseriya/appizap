...
export const BoxShadowCodeControl = codeControl<string>(
  (value: unknown) => {
    const valueString = toString(value);
    ...
    throw new Error(`the argument must be type String`);
  },
  {
    expectedType: "Shadow CSS",
  }
);

export const SelectCodeControl = codeControl<string>(
  (value: unknown) => {
    const valueString = toString(value);
