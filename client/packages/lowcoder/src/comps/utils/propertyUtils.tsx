...
export function isCompWithPropertyView<C extends Comp<any> = Comp<any>>(
  ...
  return (
    "propertyView" in comp &&
    typeof (comp as any)["propertyView"] === "function"
  );
}

export const hiddenPropertyView = (children: {
  hidden: InstanceType<typeof BoolCodeControl>;
}) => children.hidden.propertyView({ label: trans("prop.hide") });

export const tooltipPropertyView = (children: {
  tooltip: InstanceType<typeof StringControl>;
}) => children.tooltip.propertyView({ label: "Tooltip" });

export const loadingPropertyView = (children: {
  loading: InstanceType<typeof BoolCodeControl>;
...
export const disabledFutureDatePropertyView = (children: {
  disabledFutureDates: InstanceType<typeof BoolControl | typeof BoolControl>;
}) =>
  children.disabledFutureDates.propertyView({
    label: trans("prop.disabledFutureDates"),
  });

export const disabledPastDatePropertyView = (children: {
  disabledPastDates: InstanceType<typeof BoolControl | typeof BoolControl>;
}) =>
  children.disabledPastDates.propertyView({
    label: trans("prop.disabledPastDates"),
  });
...
export const requiredPropertyView = (children: {
  required: InstanceType<typeof BoolControl>;
}) => children.required.propertyView({ label: trans("prop.required") });

export const readOnlyPropertyView = (children: {
  readOnly: InstanceType<typeof BoolControl>;
}) =>
...
export const regexPropertyView = (children: {
  regex: InstanceType<typeof RegexControl>;
}) =>
  children.regex.propertyView({
    label: trans("prop.regex"),
    placeholder: ".*",
  });
...
export const minDatePropertyView = (children: {
  minDate: InstanceType<typeof StringControl>;
}) =>
...
export const maxDatePropertyView = (children: {
  maxDate: InstanceType<typeof StringControl>;
}) =>
...
export const minTimePropertyView = (children: {
  minTime: InstanceType<typeof StringControl>;
}) =>
...
export const maxTimePropertyView = (children: {
  maxTime: InstanceType<typeof StringControl>;
}) =>
...
export const showLabelPropertyView = (children: {
  showLabel: InstanceType<typeof BoolControl>;
