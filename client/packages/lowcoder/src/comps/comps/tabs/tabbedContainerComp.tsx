...
import { TooltipCodeBlock } from "../../../../../lowcoder-design/src/components/toolTip";
...
const TabbedContainer = (props: TabbedContainerProps) => {
  let { tabs, containers, dispatch, style, headerStyle, bodyStyle, tooltip } =
    props;
