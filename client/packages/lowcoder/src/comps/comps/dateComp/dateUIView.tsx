...
export const DateUIView = (props: DataUIViewProps) => {
  ...
  return useUIView(
    ...
    <DatePickerStyled
      ...
      disabledDate={(current) => disabledDate(current, props.minDate, props.maxDate, props.disabledDates, props.format, props.disabledFutureDates, props.disabledPastDates)}
      picker={"date"}
