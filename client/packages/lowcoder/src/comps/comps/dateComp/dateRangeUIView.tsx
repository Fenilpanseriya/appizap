...
export const DateRangeUIView = (props: DateRangeUIViewProps) => {
  ...
  return useUIView(
    ...
    <RangePickerStyled
      ...
      disabledDate={(current: any) => disabledDate(current, props.minDate, props.maxDate, props.disabledDates, props.format, props.disabledFutureDates, props.disabledPastDates)}
