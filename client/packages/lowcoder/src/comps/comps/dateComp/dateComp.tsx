...
import {
  disabledFutureDatePropertyView,
  disabledPastDatePropertyView,
...
import { dateRefMethods, disabledDate, disabledTime, handleDateChange } from "comps/comps/dateComp/dateCompUtil";
...
const commonChildren = {
  ...
  disabledDates: ArrayControl,
  disabledPastDates: BoolControl,
  disabledFutureDates: BoolControl,
};
  ...
  return props.label({
    ...
    children: (
      <DateUIView
        ...
        format={props.format}
        disabledPastDates={props.disabledPastDates}
        disabledFutureDates={props.disabledFutureDates}
      />
    ),
    ...validate(props),
  });
      ...
      <>
        ...
        {(useContext(EditorContext).editorModeStatus === "logic" || useContext(EditorContext).editorModeStatus === "both") && (
          <><Section name={sectionNames.validation}>
            ...
            {disabledPastDatePropertyView(children)}
            {disabledFutureDatePropertyView(children)}
            {dateValidationFields(children)}
            {timeValidationFields(children)}
            {children.customRule.propertyView({})}
            {children.disabledDates.propertyView({
              label: trans("date.disabledDate"),
              tooltip: trans("date.disableDatesTooltip")
            })}
          </Section>
