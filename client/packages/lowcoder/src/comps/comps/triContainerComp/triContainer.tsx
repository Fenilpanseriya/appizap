...
const HeaderInnerGrid = styled(InnerGrid)<{
  ...
  ${(props) =>
    ...
    `background-image: ${props.$headerBackgroundImage};`}
  ${(props) =>
    props.$headerBackgroundImageRepeat &&
    `background-repeat: ${props.$headerBackgroundImageRepeat};`}
  ${(props) =>
    props.$headerBackgroundImageSize &&
    `background-size: ${props.$headerBackgroundImageSize};`}
  ${(props) =>
    props.$headerBackgroundImagePosition &&
    `background-position: ${props.$headerBackgroundImagePosition};`}
  ${(props) =>
...
const BodyInnerGrid = styled(InnerGrid)<{
  ...
  border-top: ${(props) =>
    `${props.$showBorder ? props.$borderWidth : 0} solid ${
      props.$borderColor
    }`};
  flex: 1;
  ${(props) =>
...
const FooterInnerGrid = styled(InnerGrid)<{
  ...
  ${(props) =>
    ...
    `background-image: ${props.$footerBackgroundImage};`}
  ${(props) =>
...
export function TriContainer(props: TriContainerProps) {
  ...
  const headerHeight = showHeader ? 46 : 0;
    ...
    <div style={{ padding: style.margin, height: "100%",position:"sticky",backgroundColor:"cyan" }}>
      {loading ? (
            ...
            indicator={
              <span
                style={{
                  ...
                  minHeight: `${loadingStateHeight}px`,
                  display: "flex",
                  alignItems: "center",
        ...
        <Wrapper $style={style} title={tooltip} disabled={disabled} className="preview-container" >
            ...
            <BackgroundColorContext.Provider
              ...
              <HeaderInnerGrid
                ...
                $headerBackgroundImageRepeat={
                  headerStyle?.headerBackgroundImageRepeat
                }
                $headerBackgroundImageSize={
                  headerStyle?.headerBackgroundImageSize
                }
                ...
                <ScrollBar
                  ...
                  <BodyInnerGrid
                    ...
                    $backgroundImagePosition={
                      bodyStyle?.backgroundImagePosition
                    }
          ...
          {showFooter && (
            <BackgroundColorContext.Provider
              value={footerStyle.footerBackground}>
              <FooterInnerGrid
